"""
Schemas for OPCAL-Labeler
=========================

Pydantic-based data models for preprocessing configuration and labeled electrophysiology records.
Enable robust data validation and serialization throughout the labeling and analysis pipeline.
...
class PreprocessConfig(BaseModel):
    ...
    Attributes:
        ...
        sd_method (str): Standard deviation estimation method.
        threshold_k (float): Threshold multiplier for event detection.
    """
...
class LabelRecord(BaseModel):
    ...
    Attributes:
        ...
        uncertain (bool): If True, label is flagged as uncertain.
        notes (str): Optional notes or comments about the record.
        preprocess (PreprocessConfig): Preprocessing configuration applied to the data.
        features (Dict[str, float]): Extracted numeric features for analysis.
        peaks (List[int]): List of detected peak indices.
        version (str): Schema or tool version.
    """
    recording_id: str
    cell_id: str
    fs_hz: float
